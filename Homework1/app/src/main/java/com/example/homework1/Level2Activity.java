...
public class Level2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private long timeLeftInMiliseconds=17000;
   ...
   // int score=0;
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(turn==3)
                {
                    ...
                    t1.speak("You finish level2 go to next level",TextToSpeech.QUEUE_FLUSH,null);
                }
                else
                {
                    setImages();
    ...
    {
        int minutes=(int)timeLeftInMiliseconds/17000;
        int seconds=(int)timeLeftInMiliseconds % 17000/1000;
