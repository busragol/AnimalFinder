...
public class Level3Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private long timeLeftInMiliseconds=14000;
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(turn==3)
                {
                    ...
                    t1.speak("You finish level3 go to next level",TextToSpeech.QUEUE_FLUSH,null);
                }
                else
                {
                    setImages();
   ...
   private void openLevel4()
    ...
    {
        int minutes=(int)timeLeftInMiliseconds/14000;
        int seconds=(int)timeLeftInMiliseconds % 14000/1000;
