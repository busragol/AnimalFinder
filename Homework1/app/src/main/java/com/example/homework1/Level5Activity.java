...
public class Level5Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private long timeLeftInMiliseconds=8000;
   ...
   // int score=0;
    ...
    private void setImages(){
        ...
        do{
            wrongAnswer6=r.nextInt(20);
        }while(wrongAnswer6==images_numbers[turn] || wrongAnswer6==wrongAnswer5 || wrongAnswer6==wrongAnswer4 || wrongAnswer6==wrongAnswer3 || wrongAnswer6==wrongAnswer2 || wrongAnswer6==wrongAnswer1);
        do{
            wrongAnswer7=r.nextInt(20);
        }while(wrongAnswer7==images_numbers[turn] || wrongAnswer7==wrongAnswer6 || wrongAnswer7==wrongAnswer5 || wrongAnswer7==wrongAnswer4 || wrongAnswer7==wrongAnswer3 || wrongAnswer7==wrongAnswer2 || wrongAnswer7==wrongAnswer1);
        ...
        switch(correctAnswer){
            ...
            case 7:
                ...
                image7.setImageResource(images[images_numbers[turn]]);
                image8.setImageResource(images[wrongAnswer7]);
                break;
            case 8:
                image1.setImageResource(images[wrongAnswer1]);
                ...
                image8.setImageResource(images[images_numbers[turn]]);
                break;
    ...
    private void checkEnd()
    {
        ...
        t1.speak("Game over! Score is "+score,TextToSpeech.QUEUE_FLUSH,null);
        ...
        alertDialogBuilder.setPositiveButton("Best Point", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                //exit game
               // finish();
              // backMain();//go back beginning of game
   ...
   /* public void backMain()
    ...
    {
        int minutes=(int)timeLeftInMiliseconds/8000;
